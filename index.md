...
Important Note: <br>
This document does not address the numerical simulation of tsunami generation and propagation; the focus is limited to GIS-based inundation mapping and evacuation analysis.</h3></div>
